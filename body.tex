...
%Figure~\ref{fig:pca} depicts the data describing the three-dimensional space using the data of the two principal components.
%
%\begin{figure} [ht!]
